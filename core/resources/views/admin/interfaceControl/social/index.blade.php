           ...
           <div class="col-md-12">
              ...
              <div class="portlet light bordered">
                 <div class="portlet-body form">
                   ...
                   @endif
                    <form class="form-horizontal" action="{{route('admin.social.store')}}" method="post" role="form">
                       {{csrf_field()}}
                       <div class="form-body">
                          <div class="row">
                             <div class="col-md-4">
                            ...
                            <table class="table table-bordered table-hover">
                               ...
                               <tbody>
                                 ...
                                 <tr id="2">
                                    ...
                                    <td>{{$social->url}}</td>
                                    <td>
                                     <button type="button" class="btn btn-danger btn-sm delete_button" data-toggle="modal" data-target="#DelModal{{$social->id}}" data-id="2">
                                     <i class="fa fa-times"></i> DELETE
                                     </button>
                                    </td>
                                 </tr>
                                 <!-- Modal for DELETE -->
                                 <div class="modal fade" id="DelModal{{$social->id}}" tabindex="-1" role="dialog">
