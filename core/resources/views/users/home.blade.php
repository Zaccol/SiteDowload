    ...
    <div class="carousel-inner">
      ...
      @foreach ($sliders as $slider)
        <div class="item @if($loop->first) active @endif">
          <img style="width:100%;" src="{{asset('assets/users/interfaceControl/slider_images/'.$slider->image)}}" alt="bannieresansnous" style="width:100%;">
      ...
      <div class="media single-service" style="padding:0px 40px;">
        ...
        <div class="media-body">
          <div class="media-heading-price-container">
            <h2 class="media-heading"><a style="color: #1C1C1C; font-size: 25px;" href="{{route('services.show', [$service->id, $service->user->id])}}" class="text-primary">{!!(strlen($service->service_title)>40) ? substr($service->service_title, 0, 40) . '...' : $service->service_title!!}</a></h2>
  ...
  @auth
    <script>
        function placeOrder(serviceID) {
          ...
          var c = confirm('Êtes-vous sûr de vouloir postuler à cette Annonces?');
