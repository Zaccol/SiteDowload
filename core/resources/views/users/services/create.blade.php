          ...
          <div class="login-admin" style="">
            ...
            <div class="login-form">
              ...
              <form onsubmit="storeService(event)" id="storeServiceForm" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                <strong style="">Titre de l'annonce *</strong><br>
                {{-- Service Title... --}}
                <input style="height:40px;" type="text" name="serviceTitle" placeholder="Titre de l'annonce" value="">
                ...
                <select class="" name="category" style="width:100%;height:40px;padding-left:35px;">
                  <option value="" disabled selected>Selectionnez une Categories</option>
                ...
                <label style="border-radius: 28px;background-color: #FF1043;color: #FFFFFF;font-weight: bold;border:none;" class="btn btn-success" style="width:200px;cursor:pointer;margin-left:-2px;margin-top:5px;">
                  <input id="serviceImages" name="images[]" style="display:none;" type="file" multiple />Choisir un fichier
                </label>
                <div class="">
